call "..\sharp.bat" "IN/" "IN/" --include "anime/*.*" --include "digital/*.*" --include "huge/*.*" --include "large/*.*" --template "{d}small/{s}.png" --max-width 960 --skip
...
call "..\sharp.bat" "IN/" "OUT/" --include "**/small/*.*" --template "{d}{s}_realanime.jpg" --model realanime --skip
call "..\sharp.bat" "IN/" "OUT/" --include "**/small/*.*" --template "{d}{s}_realdigital.jpg" --model realdigital --skip
...
call "..\sharp.bat" "IN/" "OUT/" --include "**/*.jpg" --include "**/*.png" --exclude "alpha/*.*" --exclude "anime/*.*" --exclude "digital/*.*" --exclude "**/small/*.*" --template "{d}{s}.jpg" --min-width 3840 --max-upscaled-width 3840 --skip
