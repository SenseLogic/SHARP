call "..\sharp.bat" "IN/" "IN/" --include "anime/*.*" --include "architectural/*.*" --include "building/*.*" --include "digital/*.*" --include "huge/*.*" --include "large/*.*" --template "{d}small/{s}.png" --max-width 960 --skip
...
call "..\sharp.bat" "IN/" "OUT/" --include "**/*.avif"  --template "{d}{s}.avif" --min-width 3840 --max-upscaled-width 3840 --skip
