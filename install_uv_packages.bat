...
if not exist ".venv\Scripts\python.exe" uv venv --python 3.11.9
...
uv pip install --python ".venv\Scripts\python.exe" --upgrade realesrgan basicsr ffmpeg-python opencv-python pillow pillow-avif-plugin tqdm --index-url https://pypi.org/simple --extra-index-url https://download.pytorch.org/whl/cu124
